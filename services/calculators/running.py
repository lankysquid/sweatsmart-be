...
def calculate_runs(average_pace: float, average_time: float, suggested: str) -> dict:
    ...
    easy_workout_plan = gpt_workout_details("Easy", "running", easy_time, easy_pace, "min/mile")
    ...
    medium_workout_plan = gpt_workout_details("Medium", "running", medium_time, medium_pace, "min/mile")
    ...
    hard_workout_plan = gpt_workout_details("Difficult", "running", hard_time, hard_pace, "min/mile")
