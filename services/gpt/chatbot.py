...
def gpt_workout_details(difficulty, sport, time) -> Workout:
    ...
    messages=[
        ...
        {
            "role": "user",
            "content": f"Using ten words or less plus a title such as 'Tempo Run' or 'Interval Workout'. Create a {difficulty} {sport} workout plan that lasts {time / 60} minutes, in non-json, using between fifteen and twenty words.",
        }
    ],
